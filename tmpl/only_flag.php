...
foreach($lang_country_array as $key=>$val) {
    ...
    if($action==1) echo '<a class="languagelink" href="" onclick="return false;" name="'.$key.'"><img height="11" width="16" alt="'.$val.'" src="'.JURI::root().'/modules/mod_ajaxwtranslate/tmpl/images/'.$key.'.gif" /></a>'; 
}
echo "</div>";
